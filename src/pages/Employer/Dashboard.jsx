        ...
        <nav id="sidebar" className="lg:min-w-[250px] w-max max-lg:min-w-8">
          <div 
            className={`bg-white shadow-lg h-screen fixed top-0 left-0 overflow-auto z-[99] transition-all duration-500 ${
              isSidebarOpen ? 'w-[250px] visible opacity-100' : 'lg:w-[250px] lg:visible lg:opacity-100 w-0 invisible opacity-0'
            }`}
          >
            ...
            <div className="py-4 px-4">
              ...
              <ul className="space-y-2">
                {[
                  { id: 'dashboard', label: 'Dashboard', icon: 'house', subItems: ['Analytics', 'Logistics', 'Academy'] },
                  { id: 'posts', label: 'Posts', icon: 'post', subItems: ['Help center', 'Article', 'Education'] },
                  { id: 'schedules', label: 'Schedules', icon: 'clock', subItems: ['Date', 'Time'] },
                  ...
                  <li key={item.id}>
                    ...
                    >
                      ...
                      <svg
                        ...
                        className={`w-3 fill-current ml-auto transition-transform duration-500 ${openMenus[item.id] ? 'rotate-0' : '-rotate-90'}`}
                        viewBox="0 0 451.847 451.847"
                      >
                        <path d="M225.923 354.706c-8.098 0-16.195-3.092-22.369-9.263L9.27 151.157c-12.359-12.359-12.359-32.397 0-44.751 12.354-12.354 32.388-12.354 44.748 0l171.905 171.915 171.906-171.909c12.359-12.354 32.391-12.354 44.744 0 12.365 12.354 12.365 32.392 0 44.751L248.292 345.449c-6.177 6.172-14.274 9.257-22.369 9.257z" />
                      </svg>
                    </button>
                    <ul className={`ml-8 space-y-2 overflow-hidden transition-all duration-500 ${openMenus[item.id] ? 'max-h-[500px]' : 'max-h-0'}`}>
